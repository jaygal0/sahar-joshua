  ...
  return (
    <>
      ...
      <Hero
        ...
        desc="Unforgettable pre and post-celebration activities for an extended extravaganza."
        ...
        <Wrapper>
          <TextContainer>
            <Container>
              <ActivitiesWrapper>
                <Activity
                  heading="Before the Wedding BBQ Fun"
                  desc="Join us for a fun-filled gathering at our house, where we'll enjoy BBQ, drinks, and games together."
                  image="/bbq.jpg"
                  date="Thursday 20th July, 16:00"
                  location="Brinketorpsvägen 11, Partille"
                  locationLink="https://goo.gl/maps/VXBWC8G76HjX8AVT7"
                />
                <Activity
                  heading="After the Wedding Picnic Delight"
                  desc="Join us at the park for a delightful gathering filled with picnic fun and games."
                  image="/picnic.jpg"
                  date="Sunday 23rd July, 13:30 - 18:00"
                ...
                <Form onSubmit={handleSubmit}>
                  <FormContainer>
                    <GenericLabel htmlFor="eventSelect">
                      Which activity are you coming to?
                    </GenericLabel>
                    <Select
                      name="eventSelect"
                      id="eventSelect"
